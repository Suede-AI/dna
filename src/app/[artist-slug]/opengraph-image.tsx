...
// The underlying data is a static manifest, so once a given artist's OG
// card has been generated by the upstream archive.org fetch it never needs
// to change. Mark the route as never-revalidating so Vercel's CDN can hold
// the response indefinitely — first social-share hit per artist pays the
// archive.org fetch, every subsequent hit serves the cached PNG.
