...
**Project root:** `~/Documents/Ramboed/.claude/worktrees/sad-brattain-fb476c/` (the current worktree). All paths below are relative to this root unless noted.
...
```bash
cp ~/Documents/Ramboed/Suede-AI-App/launch/public/suede-mark.png public/suede-mark.png
```
